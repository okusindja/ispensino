...
import { MonographEditView } from '@/views';

const EditMonographPage: NextPageWithMonograph = ({ user, monograph }) => {
  if (!user) {
    return (
      <Div>
  ...
  return <MonographEditView monograph={monograph} />;
};
