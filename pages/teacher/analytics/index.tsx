...
import TeacherAnalyticsView from '@/views/teacher/analytics';
import { Role } from '@prisma/client';

const TeacherAnalyticsPage: NextPageWithUser = ({ user, loggedUser }) => {
  if (!user) {
    return (
      <Div>
  ...
  return <TeacherAnalyticsView user={loggedUser} />;
};
