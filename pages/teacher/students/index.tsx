...
import TeacherStudentsView from '@/views/teacher/students';

const TeacherStudentsPage: NextPageWithUser = ({ user, loggedUser }) => {
  if (!user) {
    return (
      <Div>
  ...
  return <TeacherStudentsView user={loggedUser} />;
};
