...
import CreateLessonView from '@/views/teacher/courses/details/create-lesson';

const CreateLessonPage: NextPageWithCourseAndTeacher = ({
  user,
  teacher,
  course,
}) => {
  ...
  return <CreateLessonView courseId={course.id} />;
};
