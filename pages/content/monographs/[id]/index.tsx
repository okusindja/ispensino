...
import {
  NextPageWithCourse,
  NextPageWithMonograph,
} from '@/interface/declaration';
import { adminAuth, prisma } from '@/lib';
import { CourseDetailsView, MonographDetailView } from '@/views';

const MonographsDetailsPage: NextPageWithMonograph = ({ user, monograph }) => {
  if (!user) {
    return (
      <Div>
...
export default MonographsDetailsPage;
